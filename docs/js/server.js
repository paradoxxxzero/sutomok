...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "express", "http", "fs"], factory);
    }
    ...
    (function () { return __awaiter(void 0, void 0, void 0, function () {
        var aujourdhui, origine, numeroGrille, server;
        return __generator(this, function (_a) {
            ...
            fs_1.default.access("mots/" + numeroGrille + ".txt", fs_1.default.constants.F_OK, function (err) {
                if (err) {
                    fs_1.default.writeFile("mots/" + numeroGrille + ".txt", "DIFFUSION", function (err) {
                        if (err)
                            console.error(err);
                    });
                }
