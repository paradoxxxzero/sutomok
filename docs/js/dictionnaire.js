...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./mots/listeMotsProposables"], factory);
    }
    ...
    var Dictionnaire = /** @class */ (function () {
        ...
        Dictionnaire.prototype.getMot = function (datePartie) {
            return __awaiter(this, void 0, void 0, function () {
                var aujourdhui, origine, numeroGrille;
        ...
        Dictionnaire.prototype.estMotValide = function (mot) {
            ...
            return mot.length >= 6 && mot.length <= 9 && listeMotsProposables_1.default.Dictionnaire.includes(mot);
        };
